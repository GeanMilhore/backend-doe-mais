...
public class OrganizacaoController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<OrganizacaoDto> pesquisarOrganizacao(@PathVariable Long id) {
        OrganizacaoDto organizacaoDTO = organizacaoService.pesquisarOrganizacao(id);
        return ResponseEntity.ok(organizacaoDTO);
    }

    @GetMapping
    public ResponseEntity<Page<OrganizacaoDto>> pesquisarTodasOrganizacoes(Pageable pageable) {
        return ResponseEntity.ok(organizacaoService.pesquisarTodasOrganizacoes(pageable));
    }
